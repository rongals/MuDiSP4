...
#ifndef __MUDISP2_MBLOCKREC_H 
#define __MUDISP2_MBLOCKREC_H
...
////////   InPorts and OutPorts
  ...
  InPort < gsl_matrix_complex > min1; // input seceived signals  
