 ...
 * TNT 
 *
 * The TNT - Template Numerical Toolkit (TNT) for Linear Algebra
 */

namespace TNT
{
	/*! @typedef TNT_SUBSCRIPT_TYPE Subscript
	 * @brief   This definition describes the default TNT data type used for
 indexing into TNT matrices and vectors.  The data type should
 be wide enough to index into large arrays.  It defaults to an
 "int", but can be overriden at compile time redefining TNT_SUBSCRIPT_TYPE,
 e.g.
 * @note  g++ -DTNT_SUBSCRIPT_TYPE='unsigned int'  ...
	 * @ingroup Matrix
	 * */
    typedef TNT_SUBSCRIPT_TYPE Subscript;
}
